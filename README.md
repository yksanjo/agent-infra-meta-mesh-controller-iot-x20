# agent-infra-meta-mesh-controller-iot-x20

## Detailed Description

agent-infra-meta-mesh-controller-iot-x20 is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
